...
public class OrderItem {
    private int id, orderId, productId, quantity; private BigDecimal price; private Product product;
    public OrderItem() {}
    public OrderItem(int id, int orderId, int productId, int quantity, BigDecimal price) {
        this.id = id; this.orderId = orderId; this.productId = productId; this.quantity = quantity; this.price = price;
    }
